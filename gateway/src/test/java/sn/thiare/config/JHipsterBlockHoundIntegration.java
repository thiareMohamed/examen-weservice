...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("sn.thiare.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("sn.thiare.security.DomainUserDetailsService", "createSpringSecurityUser");
